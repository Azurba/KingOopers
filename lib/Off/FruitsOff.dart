...
class FruitsStateOff extends StatefulWidget {
  String text = "";

  @override
  _FruitsOff createState() => _FruitsOff();
}

class _FruitsOff extends State<FruitsStateOff> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Fruits", style: TextStyle(color: Colors.black45),),
          centerTitle: true,
        ...
        body: ListView(
          ...
          children: [
            CardsWidgetOff('assets/images/apple.jpg', 'Apple'),
            CardsWidgetOff('assets/images/strawberry.png', 'Strawberry'),
            CardsWidgetOff('assets/images/grapes.png', 'Grapes'),
            CardsWidgetOff('assets/images/waterMelon.png', 'Watermelon'),
            CardsWidgetOff('assets/images/banana.jpg', 'Banana'),
